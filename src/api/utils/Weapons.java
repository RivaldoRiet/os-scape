...
public class Weapons {
	...
	public static boolean canSpecial(boolean equipped) {
		...
		if (SPECIAL_WEAPON.isTwoHanded() && ClientContext.instance().inventory.inventoryFull()) return false;
		boolean can = ClientContext.instance().combat.getSpecialAttackPercentage() >= SPECIAL_WEAPON.getEnergy();
