...
public class InfernoSpawnTimerInfobox extends InfoBox {
	...
	public String getText() {
		long seconds = this.running ? Math.max(0L, this.timeRemaining - Instant.now().getEpochSecond() - this.startTime)
				: this.timeRemaining;
		long minutes = seconds % 3600L / 60L;
		long secs = seconds % 60L;
		return String.format("%02d:%02d", new Object[] { Long.valueOf(minutes), Long.valueOf(secs) });
	}
